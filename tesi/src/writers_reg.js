...
class Writersreg extends React.Component {
  ...
  check(event) {
    ...
    createUserWithEmailAndPassword(
      ...
      .then(() => {
        this.setState({
          logged: true,
          error: "Complimenti, sei entrato nel mondo di Carontech!",
        });
      })
  ...
  render() {
    ...
    if (this.state.logged === true)
      ...
      reg = (
        <label className="fields">
          <button id="r_button" onClick={(event) => this.check(event)}>
        ...
        <div id="form">
          ...
          <form>
            ...
            <label className="fields">
              ...
              <input
                placeholder="Che lavoro fai? Hai qualche titolo? Sei esperto in qualcosa? Indicalo qui"
                onChange={(event) =>
